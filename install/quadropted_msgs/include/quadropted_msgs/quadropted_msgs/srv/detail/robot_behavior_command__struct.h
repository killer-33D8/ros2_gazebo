...
enum
{
  quadropted_msgs__srv__RobotBehaviorCommand_Event__request__MAX_SIZE = 1
};
// response
enum
{
  quadropted_msgs__srv__RobotBehaviorCommand_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/RobotBehaviorCommand in the package quadropted_msgs.
typedef struct quadropted_msgs__srv__RobotBehaviorCommand_Event
{
  service_msgs__msg__ServiceEventInfo info;
  quadropted_msgs__srv__RobotBehaviorCommand_Request__Sequence request;
  quadropted_msgs__srv__RobotBehaviorCommand_Response__Sequence response;
} quadropted_msgs__srv__RobotBehaviorCommand_Event;

// Struct for a sequence of quadropted_msgs__srv__RobotBehaviorCommand_Event.
typedef struct quadropted_msgs__srv__RobotBehaviorCommand_Event__Sequence
{
