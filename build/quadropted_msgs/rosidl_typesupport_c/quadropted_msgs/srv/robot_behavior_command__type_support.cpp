...
static const _RobotBehaviorCommand_Event_type_support_symbol_names_t _RobotBehaviorCommand_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, quadropted_msgs, srv, RobotBehaviorCommand_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, quadropted_msgs, srv, RobotBehaviorCommand_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, quadropted_msgs, srv, RobotBehaviorCommand_Event)() {
  return &::quadropted_msgs::srv::rosidl_typesupport_c::RobotBehaviorCommand_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t RobotBehaviorCommand_service_type_support_handle = {
  ...
  &RobotBehaviorCommand_Request_message_type_support_handle,
  &RobotBehaviorCommand_Response_message_type_support_handle,
  &RobotBehaviorCommand_Event_message_type_support_handle,
