...
class Init_RobotBehaviorCommand_Event_response
{
public:
  explicit Init_RobotBehaviorCommand_Event_response(::quadropted_msgs::srv::RobotBehaviorCommand_Event & msg)
  : msg_(msg)
  {}
  ::quadropted_msgs::srv::RobotBehaviorCommand_Event response(::quadropted_msgs::srv::RobotBehaviorCommand_Event::_response_type arg)
  {
...
private:
  ::quadropted_msgs::srv::RobotBehaviorCommand_Event msg_;
};

class Init_RobotBehaviorCommand_Event_request
{
public:
  explicit Init_RobotBehaviorCommand_Event_request(::quadropted_msgs::srv::RobotBehaviorCommand_Event & msg)
  : msg_(msg)
  {}
  Init_RobotBehaviorCommand_Event_response request(::quadropted_msgs::srv::RobotBehaviorCommand_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_RobotBehaviorCommand_Event_response(msg_);
  }
...
class Init_RobotBehaviorCommand_Event_info
{
public:
  Init_RobotBehaviorCommand_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_RobotBehaviorCommand_Event_request info(::quadropted_msgs::srv::RobotBehaviorCommand_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_RobotBehaviorCommand_Event_request(msg_);
  }
...
template<>
inline
auto build<::quadropted_msgs::srv::RobotBehaviorCommand_Event>()
{
  return quadropted_msgs::srv::builder::Init_RobotBehaviorCommand_Event_info();
}
