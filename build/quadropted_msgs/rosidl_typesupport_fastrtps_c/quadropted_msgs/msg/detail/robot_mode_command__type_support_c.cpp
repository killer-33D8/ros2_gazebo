...
bool cdr_serialize_quadropted_msgs__msg__RobotModeCommand(
  const quadropted_msgs__msg__RobotModeCommand * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_quadropted_msgs
bool cdr_deserialize_quadropted_msgs__msg__RobotModeCommand(
  eprosima::fastcdr::Cdr & cdr,
  quadropted_msgs__msg__RobotModeCommand * ros_message)
{
  // Field name: mode
  {
    std::string tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_quadropted_msgs
bool cdr_serialize_key_quadropted_msgs__msg__RobotModeCommand(
  const quadropted_msgs__msg__RobotModeCommand * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: mode
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_quadropted_msgs
size_t get_serialized_size_key_quadropted_msgs__msg__RobotModeCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RobotModeCommand__ros_msg_type * ros_message = static_cast<const _RobotModeCommand__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_quadropted_msgs
size_t max_serialized_size_key_quadropted_msgs__msg__RobotModeCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const quadropted_msgs__msg__RobotModeCommand * ros_message = static_cast<const quadropted_msgs__msg__RobotModeCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_quadropted_msgs__msg__RobotModeCommand(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  quadropted_msgs__msg__RobotModeCommand * ros_message = static_cast<quadropted_msgs__msg__RobotModeCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_quadropted_msgs__msg__RobotModeCommand(cdr, ros_message);
}
