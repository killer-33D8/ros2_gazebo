...
bool cdr_serialize_quadropted_msgs__msg__RobotFootContact(
  const quadropted_msgs__msg__RobotFootContact * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_quadropted_msgs
bool cdr_deserialize_quadropted_msgs__msg__RobotFootContact(
  eprosima::fastcdr::Cdr & cdr,
  quadropted_msgs__msg__RobotFootContact * ros_message)
{
  // Field name: contacts
  {
    size_t size = 4;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_quadropted_msgs
bool cdr_serialize_key_quadropted_msgs__msg__RobotFootContact(
  const quadropted_msgs__msg__RobotFootContact * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: contacts
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_quadropted_msgs
size_t get_serialized_size_key_quadropted_msgs__msg__RobotFootContact(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RobotFootContact__ros_msg_type * ros_message = static_cast<const _RobotFootContact__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_quadropted_msgs
size_t max_serialized_size_key_quadropted_msgs__msg__RobotFootContact(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const quadropted_msgs__msg__RobotFootContact * ros_message = static_cast<const quadropted_msgs__msg__RobotFootContact *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_quadropted_msgs__msg__RobotFootContact(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  quadropted_msgs__msg__RobotFootContact * ros_message = static_cast<quadropted_msgs__msg__RobotFootContact *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_quadropted_msgs__msg__RobotFootContact(cdr, ros_message);
}
